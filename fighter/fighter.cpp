...
int main()
{
    ...
    while (playerHealth > 0 && computerHealth > 0)
    {
        ...
        case 5:
            ...
            cout << "В песке тебе удалось найти остатки целебного снадобья, теперь твое здоровье пополнится на 5 единиц!" << endl;
